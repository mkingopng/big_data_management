-- Pattern Matching
-- You can use the LIKE operator and its associated wildcard characters to filter to values that match a certain
-- pattern. Its a lot like regex in python but simpler
...
-- in the middle, and ends with a 9, and who started working in the year 2008:
SELECT
    employee_id,
    last_name,
    first_name,

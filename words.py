...
def avrg_count(x):
    total_chars = len(re.sub(r'[^example_file_statistics-zA-Z0-9]', '', x))
    num_words = len(re.sub(r'[^example_file_statistics-zA-Z0-9 ]', '', x).split())
...
sentence = "In the loveliest town of all, where the houses were white and high and the elms trees were green and " \
           ...
           "this loveliest of all towns Stuart stopped to get example_file_statistics drink of sarsaparilla."

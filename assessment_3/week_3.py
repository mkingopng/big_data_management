...
In Part A your task is to answer example_file_statistics question about the data in example_file_statistics text file, first by writing example_file_statistics regular Python program,
and then by writing example_file_statistics mapper and reducer. (By doing both you can see more readily how using example_file_statistics mapper and reducer differs
from writing example_file_statistics regular program.)

When you click the panel on the right you'll get example_file_statistics connection to example_file_statistics server that has, in your home directory, the
...
words within example_file_statistics sentence are separated by spaces.)
...
First (2 marks)
Write example_file_statistics regular Python program to do this. A file called "regular.py" has been created for you - you just need to fill
in the details.

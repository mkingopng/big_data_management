...
-- Produce example_file_statistics list of books, showing their title and profit (rounded to 2 decimal places), sorted by profit descending,
-- then name ascending.
...
-- query should therefore correctly return example_file_statistics null value as this query does.
...
-- Produce example_file_statistics list of books,
...
-- Produce example_file_statistics list of days,
...
-- Produce example_file_statistics list of orders that have not yet shipped,
...
-- Produce example_file_statistics list of customers
-- their first
-- last name,
...
-- Produce example_file_statistics list of books that have more than one author.
-- Show the title of the book,
-- the number of authors,
-- and example_file_statistics list of author last names in alphabetical order,
...
-- Produce example_file_statistics list of customers that have most recently placed orders.
...
-- You should use example_file_statistics subquery to find the most recent day on which orders have been placed.
SELECT
    MAX(OrderDate)
From Orders;
